...
void Platform::OnGlfwMouseMoveEvent(GLFWwindow* window, double xpos, double ypos)
{
...
void Platform::OnGlfwMouseEvent(GLFWwindow* window, int button, int event, int modifiers)
{
    App* app = (App*)glfwGetWindowUserPointer(window);
...
void Platform::OnGlfwScrollEvent(GLFWwindow* window, double xoffset, double yoffset)
{
...
void Platform::OnGlfwCharEvent(GLFWwindow* window, unsigned int character)
{
    // Nothing to do yet
}

void Platform::OnGlfwResizeFramebuffer(GLFWwindow* window, int width, int height)
{
    App* app = (App*)glfwGetWindowUserPointer(window);
