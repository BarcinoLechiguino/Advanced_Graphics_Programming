...
void    LogString                   (const char* str);              // It logs a string to whichever outputs are configured in the platform layer. By default, the string is printed in the output console of VisualStudio.